...
class _BoolAdapter extends PrefAdapter<bool> {
  @override
  Future<void> write(SharedPreferences prefs, String key, bool value) =>
...
class _StringListAdapter extends PrefAdapter<List<String>> {
  @override
  Future<void> write(SharedPreferences prefs, String key, List<String> value) =>
      prefs.setStringList(key, value);
  @override
  List<String>? read(SharedPreferences prefs, String key) =>
...
class SharedPrefHelper {
  ...
  Future<void> saveLanguageIndex(int value) =>
      set<int>(_selectedLanguage, value);
  ...
  Future<void> saveIntroducer(IntroducerModel value) =>
      set<Map<String, dynamic>>(_introducerKey, value.toJson());

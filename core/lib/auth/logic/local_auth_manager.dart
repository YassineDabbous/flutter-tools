...
class AuthLocalManager {
  ...
  AuthLocalManager({SharedPrefHelper? prefs}) : _prefs = prefs ?? Core.get<SharedPrefHelper>();
  ...
  Future<AuthResponse?> getCurrentUser() async {
    logAuth.debug("-------------- Fetching CURRENT_USER from SharedPreferences ... ---------------");
    ...
    logAuth.debug("-------------- checking if prefs containsKey current_user ---------------");

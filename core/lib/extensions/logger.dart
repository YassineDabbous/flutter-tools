...
mixin AuthLoggy implements LoggyType {
  @override
  Loggy<AuthLoggy> get loggy =>
      Loggy<AuthLoggy>('Auth - ${runtimeType.toString()}');
}
mixin ControlLoggy implements LoggyType {
  @override
  Loggy<ControlLoggy> get loggy =>
      Loggy<ControlLoggy>('CTRL - ${runtimeType.toString()}');
}
